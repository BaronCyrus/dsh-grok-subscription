...
function UsagePanel({ usage, t, busy, onRefresh, signedIn }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "usageBlock", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: Boolean(busy) || !signedIn, onClick: onRefresh, children: t("usageRefresh") }),
...
function GrokSubscriptionSection({ rpc, t }) {
  ...
  const run = async (endpoint) => {
    ...
    const shouldRefreshUsage = (endpoint === "pull" || endpoint === "login/cli" || endpoint === "login/device") && value?.ok !== false && !value?.error;
